...
export const pageContent = 'mx-auto w-full max-w-[1600px] px-6 py-6 lg:px-8 lg:py-8'

export const card = 'rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800'

export const navLink =
  'flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800'

export const navLinkActive = 'flex items-center gap-3 rounded-md bg-accent/10 px-3 py-2 text-sm font-medium text-accent dark:bg-accent/20'
